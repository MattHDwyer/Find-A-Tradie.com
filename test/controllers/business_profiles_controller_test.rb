...
class BusinessProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_profile" do
    assert_difference('BusinessProfile.count') do
      post business_profiles_url, params: { business_profile: { australian_business_number: @business_profile.australian_business_number, business_profile_description: @business_profile.business_profile_description, contact_id: @business_profile.contact_id } }
    end
  ...
  test "should update business_profile" do
    patch business_profile_url(@business_profile), params: { business_profile: { australian_business_number: @business_profile.australian_business_number, business_profile_description: @business_profile.business_profile_description, contact_id: @business_profile.contact_id } }
